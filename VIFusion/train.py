...
F2V_path='/home/rgb_ir/model/f2/Ai.pth'
F2I_path='/home/rgb_ir/model/f2/Ai.pth'
...
trainloader = DataLoader(H5Dataset("/home/rgb_ir/datasets/rail_train_128_200.h5"),batch_size=batch_size, shuffle=False, num_workers=0)
...
for epoch in range(num_epochs):
    ...
    scheduler.step()  
torch.save(model.state_dict(), os.path.join("model\VIFusion_"+timestamp+'.pth'))
